...
<div class="tx-switch">
<button data-md-color-scheme="default"><code>Default（浅色）</code></button>
<button data-md-color-scheme="slate"><code>Slate（深色）</code></button>
</div>
...
button[data-md-color-scheme='default'] > code {
    background-color: var(--md-code-bg-color);
    color: #333 !important;
}
