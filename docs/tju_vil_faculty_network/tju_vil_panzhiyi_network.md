...
> 报告生成时间：2026年8月24日  
> 个人主页：https://panzhiyi.top（另见天津大学智能与计算学部官网教师页：https://cic.tju.edu.cn/info/1068/5766.htm）  
> 所属团队：天津大学智能与计算学部（点云处理与分析、生成模型方向）。据其个人主页自述，其于2025年7月加入天津大学视觉智能实验室（ViL，冯伟教授领衔）；ViL官网教师页尚未将其列出（可能系近期加入、官网未更新），其与ViL的具体隶属层级以实验室官方信息为准。  
...
| --- | --- |
| 姓名 | 潘志一（Zhiyi Pan） |
| 职称 | 副研究员（Pre-Tenure Associate Professor，长聘教职序列的预聘期副教授级） |
| 所属单位 | 天津大学智能与计算学部·计算机学院（计算智能系） |
| 导师类型 | 硕士生导师（硕导） |
| 电子邮件 | zhypan@tju.edu.cn |
| 个人主页 | https://panzhiyi.top |
| 实验室归属 | 视觉智能实验室（ViL，冯伟教授领衔），2025年7月加入（据个人主页自述） |
| 研究领域 | 三维视觉、弱监督学习 |
| 研究方向 | 点云处理与分析、生成模型（点云弱监督语义分割、scribble监督、材质生成等） |
| 教育背景 | 山东大学泰山学堂（本科）→ 山东大学（硕士）→ 北京大学（博士，导师李戈教授） |
| 代表性发表 | NeurIPS 2024、AAAI 2025、AAAI 2024、TPAMI 2024、CVPR 2023、ICCV 2021、TIP 2019、TMM 2025 等 |
| 开源项目 | GitHub 账号 panzhiyi（AADNet、DGNet、LessIsMore、CC4S、MNRR、URSS、SuperDiffusion 等多个开源仓库） |
| 招生情况 | 长期招收硕士研究生和本科生（方向：三维视觉、多模态学习） |

## 二、教育背景与职业履历

据其个人主页（panzhiyi.top）及天津大学智能与计算学部官网教师页，其教育与职业履历如下（本报告此前收到的"本科/研究生天津大学、博士香港城市大学"等线索未获任何公开资料支持，实际履历以官网核实结果为准）：
...
1. **2021.09 – 2024.12**：鹏城实验室（Pengcheng Laboratory，深圳），访问学者（Visiting Scholar），与其北大博士阶段重叠，博士期间的主要科研工作可能在鹏城实验室完成。
2. **2025.07 至今**：加入天津大学智能与计算学部，任副研究员（Pre-Tenure Associate Professor），据个人主页自述同时加入冯伟教授领衔的视觉智能实验室（ViL），为其团队新引进的青年教师。

**参与科研项目（据个人主页）：**
- 国家自然科学基金项目（No. 62172021），参与人；
- 国家科技创新2030"新一代人工智能"重大项目（2020AAA0103501），参与人。

**代表性论文（据个人主页发表的清单，按重要性节选）：**
- NeurIPS 2024（CCF-A）：Distribution Guidance Network for Weakly Supervised Point Cloud Semantic Segmentation（一作，开源DGNet）
- AAAI 2025（CCF-A）：Point Cloud Semantic Segmentation with Sparse and Inhomogeneous Annotations（一作，开源AADNet）
- AAAI 2024（CCF-A）：Less Is More: Label Recommendation for Weakly Supervised Point Cloud Semantic Segmentation（一作，开源LessIsMore）
- TPAMI 2024（CCF-A）：CC4S: Encouraging Certainty and Consistency in Scribble-supervised Semantic Segmentation（一作）
- CVPR 2023（CCF-A）：Improving Graph Representation for Point Cloud Segmentation via Attentive Filtering（合作者Nan Zhang一作）
- ICCV 2021（CCF-A）：Scribble-supervised Semantic Segmentation by Uncertainty Reduction...（一作，开源URSS）
- TMM 2025（CCF-A）：Improving Back-projection Accuracy for Learning Indoor Point Cloud Semantic Segmentation with Fewer Image Annotations
- TIP 2019（CCF-A）：Super Diffusion for Salient Object Detection（二作）
- PR 2024 / ICME 2024 / ICME 2025 / ACCV 2020 若干。

**开源与学术影响力：** 其在 GitHub（账号 panzhiyi）开源了多个论文代码库，包括 AADNet、DGNet、LessIsMore、CC4S、MNRR、URSS、SuperDiffusion 等，代码开源习惯良好；在弱监督点云语义分割（S3DIS、ScanNet-v2 基准）方向形成了从 ICCV 2021 到 NeurIPS 2024 的连续工作线，具备一定的国际可见度。其 Google Scholar 引用量具体数据待核实。

## 三、学生培养情况

潘志一于2025年7月方加入天津大学，属于刚起步的青年教师，目前尚无已毕业的独立指导学生记录。据个人主页，其长期招收硕士研究生和本科生。以下人员为其论文署名中出现的、较可能由其参与指导或密切合作的低年级学生/ junior 研究者（均据论文署名推断，非其正式指导学生，待核实）：

### 1. Nan Zhang（张楠，推断为北京大学/鹏城实验室学生，论文合作者）
...
### 8. 在津新招生（预期）
据个人主页"长期招收硕士研究生和本科生"的表述，其2025年入津后应已开始招收天津大学硕士研究生（硕导资格），首批学生预计2025/2026年入学，具体名单待核实。

总体而言，其独立的学生培养刚刚起步；当前网络中的"学生"多为读博期间在北大、山大课题组的师弟师妹与跨校合作学生，这些人是其未来科研合作与潜在引才渠道的重要组成部分。
...
据论文署名统计（基于个人主页发表列表，截至2025年）：

| 合作者 | 单位（据公开资料） | 合作要点 | 合作频次（据署名） |
| --- | --- | --- | --- |
...
整体上，其网络具有"师承扎实、跨界（图形学↔视觉↔学习）融合、开源驱动"的特征，国际连接（利兹、UCSD、NUS、Temple/Stevens、腾讯美洲）为其提供了良好的国际视野，但合作深度仍以国内山东大学—北京大学双轴心为主。

## 五、业界合作关系深度分析

### 5.1 核心业界伙伴

- **腾讯（Tencent）**：腾讯（美洲）的刘杉（Shan Liu）博士是其 AAAI 2024、AAAI 2025 两篇点云弱监督分割论文的合作者。刘杉为腾讯多媒体实验室资深专家，是视频编码与三维视觉方向的产业界学者。该连接是潘志一目前最明确的产业界学术纽带，但其是否对应正式的产学研项目待核实。
- **鹏城实验室（Pengcheng Laboratory）**：国家战略科技力量（广东省主导的新型研发机构）。潘志一2021.09–2024.12期间为访问学者，并参与国家科技创新2030重大项目（2020AAA0103501）。虽然鹏城实验室属研究机构而非企业，但其与华为等业界力量的关联紧密，这段经历构成其与国家级科研平台的合作基础。
- **其他潜在渠道**：其参与的国家自然科学基金项目（62172021）负责人及合作单位待核实；尚未发现其与具体企业（如华为、字节、大疆等）的联合项目、横向课题或专利转让的公开记录。总体业界合作仍处于起步阶段，与其2025年方独立任职的资历相符。

### 5.2 产学研合作模式

基于现有公开信息，其产学研模式可归纳为：

1. **"产业界学者联合发表"模式**：与腾讯刘杉的论文合作代表了学界-产业界研究者以共同发表为纽带的最常见合作形式，成本低、灵活，适合青年学者起步。
2. **"国家科研平台孵化"模式**：博士期间依托鹏城实验室完成主要研究并参与国家重大项目，属于我国新型研发机构与高校联合培养的典型路径；这一平台经历为其后续承接国家级项目积累资历。
3. **"开源社区辐射"模式**：其坚持为每篇代表作开源代码（GitHub panzhiyi 名下 7+ 个仓库），通过开源在工业界与社区建立影响力，这也是弱监督点云这一偏方法学方向在缺乏直接产业合作时积累业界能见度的主要方式。
4. **展望**：加入天津大学后，ViL实验室在微变视觉感知、数字文化遗产等方向已有与文博机构等的落地合作传统；潘志一的三维场景感知能力（点云分割、生成模型）在自动驾驶、机器人、AR/VR、三维重建等场景具有明确产业化潜力，未来与业界建立联合实验室或横向项目的可能性较大（推断，待观察）。

## 六、重要奖项与学术兼职

**荣誉奖项（据个人主页）：**
- 2025年：北京大学优秀毕业生（Outstanding Graduates of Peking University）；
- 2024年：北京大学优秀学者奖（Outstanding Scholar Award of Peking University）；
- 2018年：山东大学优秀毕业生（Outstanding Graduate Student of Shandong University）。

**学术兼职/服务（据个人主页）：**
- Program Chair：AAAI 2026（据个人主页自述，具体职责层级——如领域主席/程序委员会成员级别——待核实）；
...
**第三圈层（现单位ViL及天津大学网络）**：
- ViL实验室（冯伟教授领衔）团队与研究生群体，"三维场景感知"方向为其融入切入点；该圈层2025年7月方建立，天津大学本地合作网络尚在形成中。

**第四圈层（跨机构与国际/产业界连接）**：
- 国际：Anthony Cohn（利兹）、Nuno Vasconcelos（UCSD）、Haibin Ling（Stevens）、Roger Zimmermann（NUS）；
- 国家平台：鹏城实验室（访问学者，2021–2024）；
- 产业界：腾讯（刘杉，合作发表）。

**总结**：潘志一是典型的"强师承、高产出、刚独立"的青年三维视觉学者——山东大学图形学本科硕博启蒙、北京大学（深圳）博士训练叠加鹏城实验室平台，博士期间即在 NeurIPS/AAAI/TPAMI/CVPR/ICCV 等顶级 venue 形成以弱监督点云语义分割为标签的连续工作线，并保持良好的代码开源习惯。2025年7月加入天津大学ViL实验室是其学术网络的最新扩张点：他将为ViL带来点云处理与生成模型的专长，补强实验室"三维场景感知"方向；同时借助ViL在多媒体与视觉智能方向的既有资源（含冯伟团队的国家级项目与落地合作渠道）反哺其独立科研起步。其未来2–3年的关键观察点包括：以天津大学为第一单位的首批论文、首批独立指导的硕士生、与冯伟或山大/北大旧网络的联合项目，以及弱监督点云方向与自动驾驶、机器人等产业场景的实质性对接。
